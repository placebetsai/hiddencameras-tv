  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://hiddencameras.tv/og-default.png" />
        <meta property="og:image:secure_url" content="https://hiddencameras.tv/og-default.png" />
        ...
        <meta name="twitter:image" content="https://hiddencameras.tv/og-default.png" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
          ...
          <div className="border-t border-brand-border pt-5 mb-5">
            ...
            <div className="flex flex-wrap gap-x-5 gap-y-2 text-xs text-brand-muted">
              ...
              <a href="https://scooter.exchange" target="_blank" rel="noopener" className="hover:text-brand-green transition">Scooters & bikes — scooter.exchange</a>
              <a href="https://diamonds.forsale" target="_blank" rel="noopener" className="hover:text-brand-green transition">Diamond valuations — diamonds.forsale</a>
            </div>
          </div>
