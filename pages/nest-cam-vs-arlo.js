...
const PICKS = [{"r":1,"n":"Google Nest Cam (Indoor, Wired)","p":"$99.99","a":"B09FCLPLWX","w":"Best Nest indoor cam. On-device AI, familiar face detection, 24/7 recording with Nest Aware, Google Home native."},{"r":2,"n":"<a href="https://www.amazon.com/dp/B0B8GVC8QH?tag=YOUR_AMAZON_TAG-20" target="_blank" rel="noopener sponsored">Arlo</a> 5S","p":"$249.99","a":"B0C6H5DLKW","w":"Best Arlo camera. 2K HDR, color night vision, 12x zoom, HomeKit support, 6-month battery life."},{"r":3,"n":"Google Nest Doorbell (Wired)","p":"$179.99","a":"B09FCLPLWX","w":"Best Nest doorbell. 24/7 recording, on-device AI, HDR, package and familiar face detection."},{"r":4,"n":"Arlo Essential Indoor Cam","p":"$49.99","a":"B0C6GR22X1","w":"Budget Arlo option. 2K resolution, automated privacy shield, no hub needed, direct WiFi."}];
  ...
  return (
    ...
    >
      ...
      <section className="prose-dark max-w-none">
        ...
        <p>This comparison will scrutinize the latest iterations and anticipated advancements of key models like the Nest Cam Indoor, Nest Cam Outdoor, and Nest Doorbell, against Arlo’s formidable lineup including the <a href="https://www.amazon.com/dp/B0B8GVC8QH?tag=YOUR_AMAZON_TAG-20" target="_blank" rel="noopener sponsored">Arlo</a> 5S, Arlo Essential, and the flagship Arlo Ultra 2. We&apos;ll explore how their video quality, smart home integration, subscription models, and commitment to privacy stack up in a rapidly changing technological landscape.</p>
        <h2>Quick Verdict</h2>
        ...
        <li>  <strong><a href="https://www.amazon.com/dp/B0B8GVC8QH?tag=YOUR_AMAZON_TAG-20" target="_blank" rel="noopener sponsored">Arlo</a> 5S:</strong> As a mid-to-high-range camera (likely 2K HDR), it&apos;s typically priced between $180-$280, directly competing with the Nest Cam (battery/wired) but often offering higher resolution.</li>
