...
export default function Page() {
  return (
    ...
    >
      ...
      <p className="text-gray-400 mb-8 max-w-2xl">Top trail cameras for hunting, wildlife photography, and rural property security. Cellular and WiFi models reviewed. Every pick below ships from a US warehouse with fast delivery.</p>
