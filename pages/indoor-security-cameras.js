...
export default function Page() {
  return (
    ...
    >
      ...
      <p className="text-gray-400 mb-8 max-w-2xl">Top indoor cameras for home security with person detection, two-way audio, and privacy shutters. Every pick below ships from our partner store Fashionistas.ai.</p>
