...
export default function Page() {
  return (
    ...
    >
      ...
      <p className="text-gray-400 mb-8 max-w-2xl">Top-rated nanny cameras with live streaming, two-way audio, and motion alerts. Keep your kids safe when you&apos;re not home — every pick below ships from our partner store Fashionistas.ai.</p>
