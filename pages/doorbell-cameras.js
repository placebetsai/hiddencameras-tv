...
const PICKS = ROUNDUPS["doorbell-cameras"];
...
export default function Page() {
  return (
    ...
    >
      ...
      <p className="text-gray-400 mb-8 max-w-2xl">See who&apos;s at your door from anywhere. Top video doorbells with motion detection, two-way talk, and package alerts. Every pick below ships from our partner store Fashionistas.ai.</p>
