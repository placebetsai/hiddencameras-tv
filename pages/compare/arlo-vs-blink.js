...
const PICKS = [
  ...
  {"r":2,"n":"Blink Mini 2","p":"$23.99","a":"B0C7VN3NTG","w":"Best budget Blink camera. 1080p HD, night vision, two-way audio, Alexa native, USB local storage via Sync Module."},
  ...
  return (
    ...
    >
      ...
      <section className="prose-dark max-w-none">
        ...
        <h2>Video Quality</h2>
        <p><strong>Arlo Pro 5S</strong> leads with 2K HDR resolution, 160° field of view, and color night vision. The higher resolution and wider angle provide superior detail and coverage.</p>
        ...
        <p><strong>Arlo Pro 5S</strong> offers up to 6 months on a single charge. Still excellent, but requires quarterly recharging. Both brands offer solar panel accessories for extended life.</p>
        ...
        <p><strong>Outdoor:</strong> Blink Outdoor 4 at $99.99 (2-year battery) vs Arlo Pro 5S at $199.99 (6-month battery, 2K). Arlo offers better specs at double the price.</p>
