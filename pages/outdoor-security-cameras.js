...
export default function Page() {
  return (
    ...
    >
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [{"@type":"Question","name":"What outdoor camera has the best night vision?","acceptedAnswer":{"@type":"Answer","text":"The <a href="https://www.amazon.com/dp/B0B7M6VM5J?tag=YOUR_AMAZON_TAG-20" target="_blank" rel="noopener sponsored">Reolink</a> Argus 4 Pro and <a href="https://www.amazon.com/dp/B0B8GVC8QH?tag=YOUR_AMAZON_TAG-20" target="_blank" rel="noopener sponsored">Arlo</a> 5S both have excellent color night vision. For budget options, the <a href="https://www.amazon.com/dp/B0BJLXMVMV?tag=YOUR_AMAZON_TAG-20" target="_blank" rel="noopener sponsored">Wyze</a> v4 delivers surprisingly good color night vision at just $36."}},{"@type":"Question","name":"Do outdoor cameras work in winter?","acceptedAnswer":{"@type":"Answer","text":"Yes, most outdoor cameras are rated for -4°F to 113°F. Battery cameras may need more frequent charging in extreme cold. Wired cameras are unaffected by temperature."}}] }) }} />
