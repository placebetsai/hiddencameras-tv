...
export default function Page() {
  return (
    ...
    >
      ...
      <p className="text-gray-400 mb-8 max-w-2xl">Protect yourself on the road. Top dash cams with accident recording, parking mode, and GPS tracking. Every pick below ships from a US warehouse with fast delivery.</p>
